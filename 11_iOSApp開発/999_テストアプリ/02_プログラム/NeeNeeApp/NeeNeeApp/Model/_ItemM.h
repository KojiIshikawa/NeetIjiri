...
// Make changes to ItemM.h instead.

#import <CoreData/CoreData.h>

extern const struct ItemMAttributes {
...
@interface ItemMID : NSManagedObjectID {}
@end

@interface _ItemM : NSManagedObject {}
+ (id)insertInManagedObjectContext:(NSManagedObjectContext*)moc_;
+ (NSString*)entityName;
+ (NSEntityDescription*)entityInManagedObjectContext:(NSManagedObjectContext*)moc_;
@property (nonatomic, readonly, strong) ItemMID* objectID;
...
@interface _ItemM (CoreDataGeneratedPrimitiveAccessors)
