...
// Make changes to M_Job.h instead.

#import <CoreData/CoreData.h>

extern const struct M_JobAttributes {
...
@interface M_JobID : NSManagedObjectID {}
@end

@interface _M_Job : NSManagedObject {}
+ (id)insertInManagedObjectContext:(NSManagedObjectContext*)moc_;
+ (NSString*)entityName;
+ (NSEntityDescription*)entityInManagedObjectContext:(NSManagedObjectContext*)moc_;
@property (nonatomic, readonly, strong) M_JobID* objectID;
...
@interface _M_Job (CoreDataGeneratedPrimitiveAccessors)
